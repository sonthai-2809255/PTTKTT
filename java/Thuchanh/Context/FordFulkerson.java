...
public class FordFulkerson {
    ...
    private SET<Integer> incut;
    private SET<Integer> outcut;
    ...
    public FordFulkerson(FlowNetwork G, int s, int t) {
        ...
        ///  tìm tập nằm trong min_cut
        for(int v = 0; v < G.V(); v ++) {
            if(inCut(v)) this.incut.add(v);
            else this.outcut.add(v);
        }
    ...
    public static void main(String[] args) {
        ...
        // print incut and outcut
        StdOut.println("in cut: " + maxflow.MinCut());
        StdOut.println("out cut: " + maxflow.outMinCut());
        // max value
