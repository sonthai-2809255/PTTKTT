/******************************************************************************
 *  Compilation:  javac InversionsWord.java
 *  Execution:    java InversionsWord < input.txt
...
/**
 *  The {@code InversionsWord} class provides static methods to count the 
 ...
 *  @author Kevin Wayne
 */
public class InversionsWord {

    // do not instantiate
    private InversionsWord() { }
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 0; i < n; i++) {
         ...
         StdOut.println("");
        StdOut.println(InversionsWord.count(a));
        StdOut.println(InversionsWord.count(b));
